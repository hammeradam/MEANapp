...
module.exports = "<div class=\"jumbotron text-center\">\n  <h1>MEAN Aut app</h1>\n  <p class=\"lead\">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Non, tempore molestiae ad officia repellat aspernatur alias. Perspiciatis officiis quae soluta eius odit! Vel, nostrum! Hic ut sequi vitae aut itaque?</p>\n  <div>\n    <a class=\"btn btn-primary\" [routerLink]=\"['/register']\">Register</a> <a class=\"btn btn-primary\" [routerLink]=\"['/login']\">Login</a>\n  </div>\n</div>"
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessagesService.show('You are now logged in.', { cssClass: 'alert-success text-center', timeout: 3000 });
                _this.router.navigate(['/dashboard']);
            }
            else {
                _this.flashMessagesService.show(data.msg, { cssClass: 'alert-danger text-center', timeout: 3000 });
...
var NavbarComponent = (function () {
    ...
    NavbarComponent.prototype.onLogoutClick = function () {
        ...
        this.flashMessagesService.show('You are logged out.', { cssClass: 'alert-danger text-center', timeout: 3000 });
...
var RegisterComponent = (function () {
    function RegisterComponent(validatservice, flashMessagesService, authService, router) {
        this.validatservice = validatservice;
        this.flashMessagesService = flashMessagesService;
        this.authService = authService;
        this.router = router;
    }
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessagesService.show('User registered, please log in.', { cssClass: 'alert-success text-center', timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashMessagesService.show('Something went wrong. :(', { cssClass: 'alert-danger text-center', timeout: 3000 });
